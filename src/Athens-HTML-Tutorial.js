...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "runDemo\x0a    |paths extent rotation scale translation rotationSpeed zoom|\x0a    paths := self convertPathData2.\x0a\x0a    rotationSpeed := 1.\x0a    rotation := 0.\x0a    extent := surface extent.\x0a    scale := extent x / self class tigerMaxY.\x0a    translation := 0@0.\x0a    frames := 0.\x0a    looping := true.\x0a    \x0a    time := Time millisecondClockValue.\x0a    \x0a    self startLoop: [\x0a        rotation := rotation + rotationSpeed.\x0a        frames := frames + 1.\x0a\x0a        zoom := (frames/100) sin abs .\x0a        \x0a        surface \x0a\x0a            drawDuring: [:can |\x0a\x0a                can pathTransform \x0a                    loadIdentity. \x0a                    \x0a                can \x0a                    setPaint: Color white;\x0a                    drawShape: (0@0 corner: surface extent).\x0a                    \x0a                can pathTransform \x0a                    translateByX: (0.5 * (extent x - (self class tigerMaxX * scale*zoom))) Y: extent y / -12.0 ;\x0a                    scaleBy: scale*zoom ;\x0a\x0a                    translateByX: (self class tigerMaxX * 0.5) Y: (self class tigerMaxY * 0.5 );\x0a                    scaleBy: 0.8;\x0a                    rotateByDegrees: rotation;\x0a                    translateByX: (self class tigerMaxX * -0.5) Y: (self class tigerMaxY * -0.5 ).\x0a\x0a                paths do: [:each | each renderOn: can ].\x0a                \x0a            ].\x0a    ].",
